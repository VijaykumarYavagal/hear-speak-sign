...
const Sidebar = ({ toggleSidebar }: SidebarProps) => {
  ...
  return (
    <div className="fixed left-0 top-0 bottom-0 z-40 flex flex-col bg-sign-dark border-r border-white/10 transition-all duration-300 w-64">
      ...
      <div className="flex-1 overflow-y-auto py-4">
        <nav className="space-y-1 px-2">
          ...
          <Link
            to="/settings"
            className={`flex items-center space-x-3 px-3 py-2 rounded-md text-sm font-medium hover:bg-white/5 transition-colors ${isActive('/settings') ? 'bg-white/10 text-sign-primary' : ''}`}
          >
